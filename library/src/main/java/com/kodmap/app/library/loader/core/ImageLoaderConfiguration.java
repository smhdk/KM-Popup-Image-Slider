...
import com.kodmap.app.library.loader.cache.disc.DiskCache;
import com.kodmap.app.library.loader.cache.disc.naming.FileNameGenerator;
import com.kodmap.app.library.loader.cache.memory.MemoryCache;
import com.kodmap.app.library.loader.cache.memory.impl.FuzzyKeyMemoryCache;
import com.kodmap.app.library.loader.core.assist.FlushedInputStream;
...
import com.kodmap.app.library.loader.core.decode.ImageDecoder;
import com.kodmap.app.library.loader.core.download.ImageDownloader;
import com.kodmap.app.library.loader.core.process.BitmapProcessor;
import com.kodmap.app.library.loader.utils.L;
import com.kodmap.app.library.loader.utils.MemoryCacheUtils;
...
public final class ImageLoaderConfiguration {
     ...
     * <li>diskCache = {@link com.kodmap.app.library.loader.cache.disc.impl.UnlimitedDiskCache}</li>
    ...
    public static class Builder {
        ...
        /**
         * @deprecated Use
         * {@link #diskCacheExtraOptions(int, int, com.kodmap.app.library.loader.core.process.BitmapProcessor)}
         * instead
         */
        @Deprecated
         ...
         * {@link com.kodmap.app.library.loader.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
         ...
         * Default value - {@link com.kodmap.app.library.loader.cache.memory.impl.LruMemoryCache LruMemoryCache}
         ...
         * <b>NOTE:</b> If you use this method then
         * {@link com.kodmap.app.library.loader.cache.disc.impl.ext.LruDiskCache LruDiskCache}
        ...
        /**
         * @deprecated Use {@link #diskCacheFileNameGenerator(com.kodmap.app.library.loader.cache.disc.naming.FileNameGenerator)}
         */
        @Deprecated
         ...
         * Default value -
         * {@link com.kodmap.app.library.loader.core.DefaultConfigurationFactory#createFileNameGenerator()
        ...
        /**
         * @deprecated Use {@link #diskCache(com.kodmap.app.library.loader.cache.disc.DiskCache)}
         */
        @Deprecated
         ...
         * Default value - {@link com.kodmap.app.library.loader.cache.disc.impl.UnlimitedDiskCache
         * UnlimitedDiskCache}. Cache directory is defined by
         * {@link com.kodmap.app.library.loader.utils.StorageUtils#getCacheDirectory(Context)
         ...
         * Default value -
         * {@link com.kodmap.app.library.loader.core.DefaultConfigurationFactory#createImageDownloader(Context)
         ...
         * Default value -
         * {@link com.kodmap.app.library.loader.core.DefaultConfigurationFactory#createImageDecoder(boolean)
         ...
         * Consider {@link com.kodmap.app.library.loader.utils.L#disableLogging()} to disable
     ...
     * using {@link com.kodmap.app.library.loader.core.assist.FlushedInputStream}.
     *
     * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
     * @since 1.8.1
     */
