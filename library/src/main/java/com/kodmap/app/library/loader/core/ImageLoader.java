...
import com.kodmap.app.library.loader.core.assist.LoadedFrom;
import com.kodmap.app.library.loader.core.assist.ViewScaleType;
import com.kodmap.app.library.loader.core.imageaware.ImageAware;
import com.kodmap.app.library.loader.core.imageaware.ImageViewAware;
import com.kodmap.app.library.loader.core.imageaware.NonViewAware;
...
import com.kodmap.app.library.loader.utils.ImageSizeUtils;
...
public class ImageLoader {
     ...
     * @param imageAware {@linkplain com.kodmap.app.library.loader.core.imageaware.ImageAware Image aware view}
     ...
     * @param imageAware {@linkplain com.kodmap.app.library.loader.core.imageaware.ImageAware Image aware view}
     *                   which should display image
     * @param options    {@linkplain com.kodmap.app.library.loader.core.DisplayImageOptions Options} for image
     ...
     * @param progressListener {@linkplain com.kodmap.app.library.loader.core.listener.ImageLoadingProgressListener
     *                         Listener} for image loading progress. Listener fires events on UI thread if this method
     *                         is called on UI thread. Caching on disk should be enabled in
     *                         {@linkplain com.kodmap.app.library.loader.core.DisplayImageOptions options} to make
     *                         this listener work.
     * @throws IllegalStateException    if {@link #init(ImageLoaderConfiguration)} method wasn't called before
     * @throws IllegalArgumentException if passed <b>imageAware</b> is null
     */
     ...
     * {@link com.kodmap.app.library.loader.core.imageaware.ImageAware ImageAware}
     */
     ...
     * {@link com.kodmap.app.library.loader.core.imageaware.ImageAware ImageAware}.
     *
     * @param imageAware {@link com.kodmap.app.library.loader.core.imageaware.ImageAware ImageAware} for
     ...
     * {@linkplain com.kodmap.app.library.loader.core.ImageLoaderConfiguration.Builder#taskExecutor(java.util.concurrent.Executor)
