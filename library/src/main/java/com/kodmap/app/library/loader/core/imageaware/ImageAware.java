 ...
 *******************************************************************************/
package com.kodmap.app.library.loader.core.imageaware;
 ...
 * through {@link com.kodmap.app.library.loader.core.ImageLoader ImageLoader}.
 * It can wrap any Android {@link android.view.View View} which can be accessed by {@link #getWrappedView()}. Wrapped
 * view is returned in {@link com.kodmap.app.library.loader.core.listener.ImageLoadingListener ImageLoadingListener}'s
 * callbacks.
 *
...
public interface ImageAware {
    ...
    /**
     * Returns {@linkplain com.kodmap.app.library.loader.core.assist.ViewScaleType scale type} which is used for
     ...
     * {@link com.kodmap.app.library.loader.core.listener.ImageLoadingListener#onLoadingCancelled(String,
     ...
     * {@linkplain com.kodmap.app.library.loader.core.DisplayImageOptions.Builder#showImageForEmptyUri(
     *android.graphics.drawable.Drawable) for empty Uri},
     * {@linkplain com.kodmap.app.library.loader.core.DisplayImageOptions.Builder#showImageOnLoading(
     *android.graphics.drawable.Drawable) on loading} or
     * {@linkplain com.kodmap.app.library.loader.core.DisplayImageOptions.Builder#showImageOnFail(
     *android.graphics.drawable.Drawable) on loading fail}. These drawables can be specified in
     * {@linkplain com.kodmap.app.library.loader.core.DisplayImageOptions display options}.<br />
     * Also can be called in {@link com.kodmap.app.library.loader.core.display.BitmapDisplayer BitmapDisplayer}.< br />
     * Is called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
     *
     ...
     * {@link com.kodmap.app.library.loader.core.display.BitmapDisplayer BitmapDisplayer}.< br />
     * Is called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
     *
